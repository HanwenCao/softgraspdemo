...
#            bg1 = cv2.imread('./comp_diff/images2/0.jpg')
#            bg2 = cv2.imread('./comp_diff/images2/0.jpg')
#            height, width, channels = bg1.shape            
##            bg2 = cv2.resize(bg2, bg1.shape)
#            bg2 = cv2.resize(bg2, (height, width))
#            bg1 = PILImage.fromarray(cv2.cvtColor(bg1,cv2.COLOR_BGR2RGB))
#            bg2 = PILImage.fromarray(cv2.cvtColor(bg2,cv2.COLOR_BGR2RGB))
