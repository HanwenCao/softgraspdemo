...
def detect(save_img=False):
    ...
    depth_arr_crop[:,510:640] = fack_bg_depth
    ...
    fack_bg_rgb = (np.median(img_arr_crop[358-5:358+5,485-5:485+5,0]),np.median(img_arr_crop[358-5:358+5,485-5:485+5,1]),np.median(img_arr_crop[358-5:358+5,485-5:485+5,2]))
    print('fack_bg_rgb',fack_bg_rgb)
    fack_bg_rgb = (174.0, 149.0, 136.0)  # a fixed value to make all imgs consistent
    img_arr_crop[0:125,:] = fack_bg_rgb
    img_arr_crop[380:480,:] = fack_bg_rgb
    img_arr_crop[:,0:170] = fack_bg_rgb
    img_arr_crop[:,510:640] = fack_bg_rgb
