...
from .grasp_data_k import GraspDatasetBase
from utils.dataset_processing import grasp_k as grasp #from utils.dataset_processing import grasp
from utils.dataset_processing import image
# import cv2
# import matplotlib.pyplot as plt


class CornellDatasetk(GraspDatasetBase):
    """
    Dataset wrapper for the Cornell dataset. grasps include k  
    """
    def __init__(self, file_path, start=0.0, end=1.0, ds_rotate=0, **kwargs):
        ...
        """
        super(CornellDatasetk, self).__init__(**kwargs)
